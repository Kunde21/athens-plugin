...
func (p Plugin) Zip(ctx context.Context, module string, vsn string) (io.ReadCloser, error) {
...
func (p Plugin) Save(ctx context.Context, module string, version string, mod []byte, zip io.Reader, info []byte) error {
